...
REM test_ctypes
%PYTHON% -m test.regrtest test_copy_reg test_cpickle test_cprofile test_crypt test_csv test_curses test_datetime test_dbm test_decimal
%PYTHON% -m test.regrtest test_decorators test_defaultdict test_deque test_descr test_descrtut test_dict test_dictcomps test_dictviews test_difflib
REM test_distutils
%PYTHON% -m test.regrtest test_dircache test_dis test_dl test_doctest test_doctest2
REM test_email test_email_renamed
%PYTHON% -m test.regrtest test_docxmlrpc test_dumbdbm test_dummy_thread test_dummy_threading test_email_codecs test_ensurepip test_enumerate test_eof
...
REM test_ftplib
%PYTHON% -m test.regrtest test_fileinput test_fileio test_float test_fnmatch test_fork1 test_format test_fpformat test_fractions test_frozen
...
REM test_hash
%PYTHON% -m test.regrtest test_glob test_global test_grammar test_grp test_gzip test_hashlib test_heapq test_hmac test_hotshot
...
REM test_json test_lib2to3
%PYTHON% -m test.regrtest test_isinstance test_iter test_iterlen test_itertools test_kqueue test_largefile test_linecache test_linuxaudiodev
...
REM test_ssl
%PYTHON% -m test.regrtest test_softspace test_sort test_source_encoding test_spwd test_sqlite test_startfile test_stat test_str test_strftime
...
REM test_unittest
%PYTHON% -m test.regrtest test_unicode test_unicode_file test_unicodedata test_univnewlines test_univnewlines2k test_unpack test_urllib test_urllib2 test_urllib2_localnet
