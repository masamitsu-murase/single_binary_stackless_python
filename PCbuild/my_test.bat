...
%PYTHON% -m test.regrtest -x test_argparse test_asynchat test_asyncore test_calendar test_class test_cmath test_class test_cmath test_codecs test_ctypes test_distutils test_email test_email_renamed test_ensurepip test_ftplib test_hash test_importlib test_json test_lib2to3 test_macpath test_unittest test_rlcompleter test_readline test_warnings
if ERRORLEVEL 1 (
