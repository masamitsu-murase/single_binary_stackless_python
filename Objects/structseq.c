...
#ifdef STACKLESS
    unsigned long orig_tp_flags = type->tp_flags;
#endif
...
#ifdef STACKLESS
    /*
     * Preserve Py_TPFLAGS_HAVE_STACKLESS_EXTENSION, because we do not modify
     * type->tp_as_mapping.
     */
    type->tp_flags &= ~Py_TPFLAGS_HAVE_STACKLESS_EXTENSION;
    type->tp_flags |= orig_tp_flags & Py_TPFLAGS_HAVE_STACKLESS_EXTENSION;
#endif
